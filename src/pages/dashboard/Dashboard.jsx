...
//   // State for user info (fetch from database)
...
//   // Placeholder appointments (replace with database fetch logic)
//   const [appointments, setAppointments] = useState([]);

//   useEffect(() => {
//     // Simulate fetching user info and appointments from a database
...
//           <div className="logo mb-4">Dr.CureX</div>
...
//               { icon: "src/assets/icons/report-analysis.png", title: "Report Analysis", buttonText: "Analyze", path: "#" },
...
//                       disabled={card.path === "#"} // Disable button if no route is provided
//                     >
//                       {card.buttonText}
//                     </Button>
//                   </Card.Body>
